 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://java-soa.blogspot.com/", wsdlLocation = "file:/C:/DevLM/eclipse/work/space001/wsJax/WebContent/WEB-INF/wsdl/HelloWorld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://java-soa.blogspot.com/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/DevLM/eclipse/work/space001/wsJax/WebContent/WEB-INF/wsdl/HelloWorld.wsdl");
    ...
    public HelloWorldPortType getHelloWorldPort() {
        return super.getPort(new QName("http://java-soa.blogspot.com/", "HelloWorldPort"), HelloWorldPortType.class);
    }
    ...
    public HelloWorldPortType getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://java-soa.blogspot.com/", "HelloWorldPort"), HelloWorldPortType.class, features);
    }
