...
<body bgcolor="${colorPreferences.background}" text="${colorPreferences.foreground}">
...
<fieldset>
  ...
  <form action="get-customer" method="post">
    ...
    <label>
      ...
      <input type="text" name="fg" value="${colorPreferences.foreground}"/>
    </label><br/>
    <label>
      Preferred background color: 
      <input type="text" name="bg" value="${colorPreferences.background}"/>
    </label><br/>
