...
<html>
  ...
  <body>
    <h1><spring:message code="application.create.name"/></h1>
              ...
              <tr>
                <td width="20">
                  <a href="<c:url value='countryForm.html?id=${country.id}'/>">
                    <img src="static/images/edit.gif" style="border-style:none;"/>
                  </a>
                </td>
                <td>
                  <a href="countryDetailsCreate.html?id=${country.id}">${country.name}</a>
                </td>
              </tr>
            </c:forEach>
          </table>
